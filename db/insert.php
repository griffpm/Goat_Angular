...
if (!isset($data->first_name) || !isset($data->last_name) || !isset($data->company)) :
    echo json_encode([
        'success' => 0,
        'message' => 'Please enter compulsory fileds |  First Name, Last Name and company',
    ]);
    exit;
 
elseif (empty(trim($data->first_name)) || empty(trim($data->last_name)) || empty(trim($data->company))) :
