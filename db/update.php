...
if (!isset($data->id)) {
    echo json_encode(['success' => 0, 'message' => 'Please enter correct Goat id.']);
    exit;
}
...
try {
    ...
    if ($fetch_stmt->rowCount() > 0) :
       ...
       $update_query = "UPDATE `goats` SET first_name = :first_name, last_name = :last_name, company = :company, date_of_birth = :date_of_birth, url_img = :url_img
        WHERE id = :id";
